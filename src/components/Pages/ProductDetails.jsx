...
const Border = () => {
  return <div className="border w-[780px]"></div>;
};
    ...
    <Container className={"mt-[124px] mb-[140px]"}>
      ...
      <div className="text">
        ...
        <div className="price flex items-center gap-x-[22px] mt-5 mb-6">
          ...
          <span className="text-[20px] font-sans font-bold text-[#262626]">
            $44.00
          </span>
        </div>
        ...
        <div className="color mt-[29px] flex gap-x-[53px]">
          ...
          <div className="flex items-center gap-x-[15px]">
            <div
              className={`bg-[#979797] transition-all w-5 h-5 duration-100 rounded-full cursor-pointer`}
            ></div>

            <div
              className={`bg-[#FF8686] transition-all w-5 h-5 duration-100 rounded-full cursor-pointer`}
            ></div>

            <div
              className={`bg-[#7ED321] transition-all w-5 h-5 duration-100 rounded-full cursor-pointer`}
            ></div>

            <div
              className={`bg-[#B6B6B6] transition-all w-5 h-5 duration-100 rounded-full cursor-pointer`}
            ></div>

            <div
              className={`bg-[#15CBA5] transition-all w-5 h-5 duration-100 rounded-full cursor-pointer`}
            ></div>
          </div>
        </div>
        ...
        <div className="quantity mt-9 mb-[30px] flex items-center gap-x-[30px]">
          ...
          <div className="flex items-center gap-x-2 border border-[#F0F0F0]">
            <p
              onClick={() =>
                setQuantity(quantity < 2 ? (quantity = 1) : (quantity -= 1))
              }
              className="text-[#767676] font-sans leading-[30px] py-1 px-[19px] cursor-pointer"
            >
              -
            </p>
            <p className="text-[#767676] font-sans leading-[30px] py-1 px-4">
              {quantity}
            </p>
            <p
        ...
        <div className="button mt-[29px] mb-[30px]">
          <Button
            ...
            className={"mr-5 bg-white border border-black !text-black"}
          />
        ...
        <div className="accordion mt-6">
          <div className="first w-[780px]  pb-6 border-b border-b-[#F0F0F0]">
            <div className="title flex items-center justify-between w-full">
              <p className="font-bold text-[#262626] font-sans">
                FEATURES & DETAILS
              </p>
              <p
            ...
            <p
              className={`${
                accShow
                  ? "text-[16px] mt-3 leading-[30px]"
                  : "text-[0px] mt-0 leading-0"
              }  font-sans  text-[#767676]`}
            >
        ...
        <p className="text-[#767676] font-sans mt-[14px] leading-[30px] w-[780px]">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua.
        </p>
      </div>
