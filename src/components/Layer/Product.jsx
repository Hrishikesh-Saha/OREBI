...
const Li = ({name, icon}) => {
  ...
  return (
    <li className='flex justify-end gap-x-2 items-center cursor-pointer'>
    <p className='transition-all duration-300 font-sans md:text-base text-[10px] font-bold text-black md:text-[#767676] hover:text-black'>{name}</p>
    {icon}
    </li>
  );
  ...
  return (
    ...
    <div className={`md:w-[370px] w-[147px] relative ${className}`}>
        ...
        <div className="image w-full h-[207px] md:h-[370px] relative group cursor-pointer">
            ...
            <img className='w-full h-full object-cover' src={productImage} alt="missing" />
        ...
        <div className={`offer absolute left-2 top-2 md:left-5 md:top-5 bg-[#262626] py-1 px-3 md:py-2 md:px-8 ${OfferEye?"visible":"invisible"}`}>
